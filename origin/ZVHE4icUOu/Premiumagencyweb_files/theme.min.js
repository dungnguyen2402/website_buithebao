...
! function () {
    "use strict";
    var t, e, r, a, n, o;
    null !== (e = document.querySelector('[data-bs-toggle="mode"]')) && (t = e.querySelector(".form-check-input"), "light" === mode ? (root.classList.remove("dark-mode"), t.checked = !1) : (root.classList.add("dark-mode"), t.checked = !0), e.addEventListener("click", function (e) {
        ...
        function () {
            for (var e = document.querySelectorAll(".password-toggle"), r = 0; r < e.length; r++) ! function () {
        ...
        function () {
            for (var n = document.querySelectorAll(".range-slider"), o = 0; o < n.length; o++) ! function () {
        ...
        function () {
            ...
            if (0 !== a.length)
                for (var n = 0; n < a.length; n++) ! function () {
                    var e, t = a[n],
        ...
        function () {
            var n, r = document.querySelectorAll(".masonry-grid");
            if (null !== r)
                for (var o = 0; o < r.length; o++) {
                    var e = function () {
                        ...
                        for (var e = a.querySelectorAll(".masonry-filters [data-group]"), t = 0; t < e.length; t++) e[t].addEventListener("click", function (e) {
        ...
        function () {
            ...
            if (null !== e) {
                for (var l = 0; l < e.length; l++) ! function () {
            ...
            if (0 !== v.length)
                for (var e = function () {
                        ...
                        0 < r.readyState ? (d(), p(), f()) : r.addEventListener("loadedmetadata", function () {
                            d(), p(), f()
                        }), r.addEventListener("progress", f), a.addEventListener("input", function () {
